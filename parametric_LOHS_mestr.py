...
p_prim_v_m2=np.loadtxt('masa_estr_mitad.txt')
p_prim_v_m3=np.loadtxt('masa_estr_por3.txt')
p_prim_v_m4=np.loadtxt('masa_estr_por4.txt')

plt.figure(0)
plt.grid()
plt.plot(t_v, p_prim_v_mt/1e6,            label = 'm_estr = 196 Ton')
plt.plot(t_v, p_prim_v_m2/1e6,  '--', label = 'm_estr = 294 Ton')
plt.plot(t_v, p_prim_v_m3/1e6,  '--', label = 'm_estr = 588 Ton')
plt.plot(t_v, p_prim_v_m4/1e6,  '--', label = 'm_estr = 98 Ton')
