...
fracc_g_m=mg_nom/m_tot_prim_nom
...
Vol_N2_nom = 19 #m3
Vol_N2_max = Vol_N2_nom + Vol_l_SIE_nom
nivel_l_SIE_nom = Vol_l_SIE_nom/Vol_N2_max
...
trip_SCRAM = False
t_SCRAM_manual = 3600000 # Demanda manual de SCRAM por tiempo
...
Result_masav=[] #Es una matriz donde voy a poner las cosas
...
for i in range(N):
	...
	##            gamma     = 1   # expansión isotérmica
            ...
            Vol_l_SIE   = Vol_N2_max - Vol_N2_1
            nivel_l_SIE = Vol_l_SIE/Vol_N2_max
...
np.savetxt('qsecr_real15.txt',p_prim_v)
