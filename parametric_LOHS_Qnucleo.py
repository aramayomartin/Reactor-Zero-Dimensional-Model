...
p_prim_v_m2=np.loadtxt('qnucleo_mitad.txt')
p_prim_v_m3=np.loadtxt('qnucleo_uno_cinco_e.txt')
#p_prim_v_m4=np.loadtxt('masa_estr_por4.txt')

plt.figure(0)
plt.grid()
plt.plot(t_v, p_prim_v_mt/1e6,            label = 'Q_th = 100 MW')
plt.plot(t_v, p_prim_v_m2/1e6,  '--', label = 'Q_th = 50 MW')
plt.plot(t_v, p_prim_v_m3/1e6,  '--', label = 'Q_th = 150 MW')
