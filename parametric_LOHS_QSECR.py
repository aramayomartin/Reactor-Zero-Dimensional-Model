...
p_prim_v_m2=np.loadtxt('qsecr_real.txt')
p_prim_v_m3=np.loadtxt('qsecr_real15.txt')
#p_prim_v_m4=np.loadtxt('masa_estr_por4.txt')

plt.figure(0)
plt.grid()
plt.plot(t_v, p_prim_v_mt/1e6,            label = 'T_SECR = 373.15 K')
plt.plot(t_v, p_prim_v_m2/1e6,  '--', label = 'T_SECR = 323.15 K')
plt.plot(t_v, p_prim_v_m3/1e6,  '--', label = 'T_SECR = 423.15 K')
#plt.plot(t_v, p_prim_v_m4/1e6,  '--', label = 'mt = 98 Ton')
